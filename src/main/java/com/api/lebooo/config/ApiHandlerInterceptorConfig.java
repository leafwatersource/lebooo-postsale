...
@Slf4j
@Component
public class ApiHandlerInterceptorConfig implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        try {
            ...
            String userX = jedisPoolUtils.get(ReferenceUtil.TOKENKEY+token);
            if (null == userX) {
                baseResultEntity.setCode(CodeEnum.SUCCESS_NOT_LOGIN.getCode());
            ...
            User user = userService.getUser(Long.parseLong(userX));
//            User user = userService.getUser(17L);
            if (user == null) {
                baseResultEntity.setCode(CodeEnum.SUCCESS_NOT_LOGIN.getCode());
